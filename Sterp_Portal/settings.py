"""
Django settings for Sterp_Portal project.
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-ah^-+pmt#wd-vgpqhu$=u)m!#4rnn@+d)+u5qqdg&!^_-vesi=')
...
INSTALLED_APPS = [
    ...
    'users.apps.UsersConfig',  # Make sure this is here
...
ROOT_URLCONF = 'Sterp_Portal.urls'
...
WSGI_APPLICATION = 'Sterp_Portal.wsgi.application'
...
AUTH_USER_MODEL = 'users.Employee'  # Make sure this is here
